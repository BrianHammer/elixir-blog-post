defmodule BlogPostWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {BlogPostWeb.Layouts, :root}
  ...
  if Application.compile_env(:blog_post, :dev_routes) do
  ...
  scope "/", BlogPostWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BlogPostWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BlogPostWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BlogPostWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BlogPostWeb do
    ...
    live_session :current_user,
      on_mount: [{BlogPostWeb.UserAuth, :mount_current_user}] do
