defmodule BlogPostWeb.UserAuth do
  use BlogPostWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_blog_post_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule BlogPostWeb.PageLive do
        ...
        on_mount {BlogPostWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BlogPostWeb.UserAuth, :ensure_authenticated}] do
